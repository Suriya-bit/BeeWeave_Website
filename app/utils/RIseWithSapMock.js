...
export const riseWithSapProcessItems = [
  {
    title: "Business Discovery",
    description:
      "We look at your current SAP setup, understand your business goals and identify the right path forward for your RISE with SAP journey.",
  },
  {
    title: "Cloud Readiness Assessment",
    description:
      "We evaluate your existing systems and infrastructure to check how ready your business is for the move to SAP cloud.",
  },
  {
    title: "Migration Planning",
    description:
      "We build a clear and structured migration plan around your business needs, timeline and goals before anything moves forward.",
  },
  {
    title: "System Configuration",
    description:
      "We set up and configure your RISE with SAP environment to match your business processes and get everything ready to go live.",
  },
  {
    title: "Testing & Validation",
    description:
      "We run thorough checks across your entire SAP cloud system to confirm everything is working correctly and your business is fully prepared.",
  },
  {
    title: "Go Live & Support",
    description:
      "We support your business through going live and stay with your team afterwards, keeping your SAP cloud system running well at all times.",
  },
];
...
export const riseWithSapFaqData = [
  {
    question: "What is RISE with SAP and how does it work?",
    answer:
      "RISE with SAP is a complete cloud transformation package offered by SAP. It bundles cloud ERP, business process intelligence and infrastructure management under one single contract, making it easier for businesses across India to move to SAP cloud without dealing with multiple vendors or complex agreements.",
  },
  {
    question: "Is RISE with SAP suitable for my business?",
    answer:
      "RISE with SAP is designed for businesses of all sizes looking to move their ERP to the cloud. Whether you are a growing mid size company or a large enterprise, RISE with SAP gives your business a flexible and scalable cloud ERP solution built for long term growth.",
  },
  {
    question: "What is included in the RISE with SAP package?",
    answer:
      "RISE with SAP includes SAP S/4HANA Cloud, SAP Business Process Intelligence powered by SAP Signavio, SAP Business Network Starter Pack and cloud infrastructure management. It gives businesses everything they need for a complete SAP cloud transformation under one simple subscription.",
  },
  {
    question: "How long does a RISE with SAP migration take?",
    answer:
      "The timeline for a RISE with SAP migration depends on the size and complexity of your business. Most migrations take anywhere from 3 to 12 months. A well structured SAP cloud migration plan and the right consulting partner can help bring that timeline down significantly.",
  },
  {
    question:
      "What is the difference between RISE with SAP and a traditional SAP implementation?",
    answer:
      "A traditional SAP implementation requires businesses to manage their own infrastructure, upgrades and maintenance. RISE with SAP moves everything to the cloud under one managed subscription, giving businesses across India a simpler, more cost effective and future ready way to run their SAP environment.",
  },
  {
    question: "Will my business data be safe with RISE with SAP?",
    answer:
      "Yes. RISE with SAP is built with enterprise grade security standards. Your business data is fully protected, compliant and monitored at all times within the SAP cloud environment, giving your organisation complete confidence in the safety of its most important information.",
  },
  {
    question: "Can RISE with SAP be integrated with other business tools?",
    answer:
      "Yes. RISE with SAP can be connected with a wide range of third party applications, cloud platforms and business tools through SAP Integration Suite. This gives businesses across India a fully connected cloud ERP environment where all systems work together without any issues.",
  },
  {
    question:

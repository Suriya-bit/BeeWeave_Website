  ...
  return (
    <MainLayout className="relative px-6 lg:px-30 py-20 overflow-hidden ">
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[1200px] h-[300px] bg-[radial-gradient(circle_at_center,#9333ea_0%,transparent_70%)] blur-[160px] opacity-60 rounded-full" />
      </div>
        ...
        >
          <div className="relative rounded-2xl bg-gradient-to-b from-white/10 to-transparent p-[1px]">
            <div className="h-full w-full rounded-2xl bg-[#0b0018] p-8 backdrop-blur-xl">
              ...
              <div className="h-px w-full bg-gradient-to-r from-[#7400FA] to-transparent mb-6" />
              <ul className="space-y-4">
                {leftPoints.map((item, i) => (
                  <li key={i} className="relative text-sm text-white/60 pb-3">
                    {item}
                    <span className="absolute bottom-0 left-0 w-full h-px bg-gradient-to-r from-white/10 to-transparent" />
                  </li>
                ))}
              </ul>
            </div>

...
export const cloudProcessItems = [
  {
    ...
    description:
      "We learn about your business, your systems and your goals before we plan anything.",
  },
  {
    title: "Strategy & Roadmap",
    description:
      "We build a clear cloud plan around your business needs and timeline.",
  },
  {
    title: "Architecture Design",
    description:
      "We design a cloud setup that is safe, reliable and built for your business needs.",
  },
  {
    title: "Seamless Migration",
    description:
      "We move your systems and data to the cloud without any problems or downtime.",
  },
  {
    title: "Performance Optimization",
    description:
      "We keep your cloud environment running fast, smooth and performing at its very best.",
  },
  {
    title: "Ongoing Support",
    description:
      "We stay with your business after we go live and keep everything running well daily.",
  },
];

export const cloudImpactData = [
  {
    value: "65%+",
  ...
  {
    value: "3X",
    label: "Faster Business Scalability",
  },
  {
    value: "99.9%",
    label: "System Uptime and Availability",
  },
  {
    value: "70%",
...
export const cloudConsultancyFaqData = [
  {
    question:
      "What are cloud consultancy services and why does my business need them?",
    answer:
      "Cloud consultancy services help businesses plan, execute and manage their move to the cloud. Without the right guidance, cloud adoption can be costly and complicated. A good cloud consultant helps your business choose the right platform, build the right strategy and move to the cloud without any wasted time or money.",
  },
  {
    question:
      "What is the difference between cloud migration and cloud transformation?",
    answer:
      "Cloud migration is the process of moving your existing systems and data to the cloud. Cloud transformation goes a step further by rethinking and improving your entire business operations using cloud technology. Both are important steps and the right cloud consultancy services will help your business with both effectively.",
  },
  {
    question:
      "Which cloud platform is best for my business — AWS, Azure or Google Cloud?",
    answer:
      "The best cloud platform depends on your business size, budget and specific needs. AWS is known for its wide range of services, Microsoft Azure works well for businesses already using Microsoft tools and Google Cloud is great for data and analytics. A trusted cloud consultation company will help you pick the right one.",
  },
  {
    question: "How much does cloud migration cost?",
    answer:
      "The cost of cloud migration varies depending on the size of your business, the number of systems being moved and the complexity of your setup. Cloud migration services in India are generally more cost effective than managing your own on premise infrastructure in the long run.",
  },
  {
    question: "Is my business data safe in the cloud?",
    answer:
      "Yes. Modern cloud platforms like AWS, Azure and Google Cloud come with enterprise grade security built in. Data encryption, access control, compliance management and threat monitoring are all part of a well managed cloud environment. Your data is safe, backed up and protected at all times.",
  },
  {
